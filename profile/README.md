...
flowchart TB
    ...
    slack --> bot
    web --> map & nearme & vault & codex & orgmap & regions & status
    leaders --> bot & map
...
Each repo has its own README with setup instructions. Jump in, ask questions, and don't worry about breaking things — that's what pull requests are for.
